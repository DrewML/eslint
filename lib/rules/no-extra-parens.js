...
module.exports = {
    ...
    create: function(context) {
        ...
        /**
         * Determines if a node is a child of a return statement
         * @param {ASTNode} node - The node to be checked.
         * @returns {boolean} True if the node is a child of a return statement.
         * @private
         */
        function isChildOfReturnStatement(node) {
            while (node) {
        ...
        /**
         * Determines if a node is or is contained by a return statement and is allowed to have a parenthesised assignment
         * @param {ASTNode} node - The node to be checked.
         * @returns {boolean} True if the assignment can be parenthesised.
         * @private
         */
        function isReturnAssignException(node) {
            if (!EXCEPT_RETURN_ASSIGN || !isChildOfReturnStatement(node)) {
                return false;
            }
